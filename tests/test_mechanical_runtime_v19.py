...
class MechanicalRuntimeV19Tests(unittest.TestCase):
    ...
    def test_current_version_without_structural_rcp_always_builds_pre_submission(self,designer,integrity,health):
        ...
        designer.assert_called_once(); integrity.assert_called_once(); health.assert_called_once()
    ...
    def test_only_full_v19_pass_reaches_designer_and_stamps_report(self,pipeline,designer,integrity,health):
        ...
        answers={"_runtime_contract":active_version_manifest(),"_v19_input_contract":{}}
        result=design_mechanical_authority_site(Path("a.dxf"),Path("b.dxf"),answers=answers,plan_analysis={})
        designer.assert_called_once(); integrity.assert_called_once(); health.assert_called_once(); self.assertEqual(result["pipeline_authority"],"mechanical-v19")
