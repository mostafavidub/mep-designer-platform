...
class MechanicalHeroV3Tests(unittest.TestCase):
    ...
    def test_mechanical_page_loads_isolated_static_hero(self):
        ...
        self.assertIn('/static/mechanical-hero-v3.js?v=20260823-1103',r.text)
        self.assertIn('/service-art/mechanical.jpg?v=20260823-1103',r.text)
    ...
    def test_mechanical_hero_script_uses_only_dedicated_asset(self):
        js=self.client.get('/static/mechanical-hero-v3.js'); self.assertEqual(js.status_code,200)
        self.assertIn('/service-art/mechanical.jpg?v=20260823-1103',js.text)
    ...
    def test_mechanical_asset_route_is_jpeg(self):
