...
class HeroPinRegressionTests(unittest.TestCase):
    ...
    def test_home_runs_service_reorder_before_hero_scene(self):
        ...
        service_pos = home.text.find('/static/service-stack.js?v=20260822-1025')
        hero_pos = home.text.find('/static/hero-scroll-v1.js?v=20260822-1034')
    ...
    def test_hero_scene_targets_workflow_and_keeps_it_in_same_scene(self):
        ...
        self.assertIn('margin-top:0!important', css.text)
