...
MANIFEST_PRESENTATION_REVISION = '12.1'
...
def install(review_fix_module):
    review_fix_module.review_question_html = review_question_html
    # Backward-compatible attribute name; the value is a manifest contract revision,
    # not a Mechanical engine identity.
    review_fix_module.MANIFEST_PRESENTATION_VERSION = MANIFEST_PRESENTATION_REVISION
