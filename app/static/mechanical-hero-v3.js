  ...
  hero.innerHTML = `
    <div class="container-wide mechanical-hero-v3-grid">
      <div class="mechanical-hero-v3-art">
        <img src="https://res.cloudinary.com/pnuzoh4o/image/upload/v1787475602/engitools/mechanical-hero-20260823-final.webp" width="1672" height="941" alt="مدل سه‌بعدی سیستم‌های مکانیکی ساختمان شامل تجهیزات HVAC، کانال‌ها و لوله‌کشی روی نقشه مهندسی" decoding="async" fetchpriority="high">
      </div>
