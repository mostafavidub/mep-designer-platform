    ...
    <div class="container-wide mechanical-hero-v3-grid">
      ...
      <div class="mechanical-hero-v3-copy">
        ...
        <div class="mechanical-hero-v3-features" aria-label="مزیت‌های همراه مکانیک">
          <div class="mechanical-hero-v3-feature">تحلیل خودکار پلان معماری</div>
          <div class="mechanical-hero-v3-feature">درخواست هوشمند اطلاعات موردنیاز</div>
          <div class="mechanical-hero-v3-feature">تولید نقشه‌های تخصصی</div>
          <div class="mechanical-hero-v3-feature">محاسبات قابل استنتاج</div>
        </div>

        <div class="mechanical-hero-v3-actions">
          <a class="mechanical-hero-v3-primary" href="#start">شروع پروژه جدید <span aria-hidden="true">←</span></a>
          <a class="mechanical-hero-v3-secondary" href="#real-samples">مشاهده نمونه پروژه</a>
        </div>
      </div>

      <div class="mechanical-hero-v3-meta" aria-label="مشخصات همراه مکانیک">
        <div><b>فرمت ورودی</b><span>DXF / ZIP</span></div>
        <div><b>خروجی‌ها</b><span>نقشه، دیتیل، محاسبات</span></div>
        <div><b>تحلیل سریع</b><span>Architecture-first</span></div>
