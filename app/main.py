...
QUESTION_OPTIONS = {
    ...
    'heights': ['۳٫۲۰ متر؛ سقف کاذب فضاهای تر ۴۰ سانتی‌متر', '۳٫۰۰ متر؛ سقف کاذب فضاهای تر ۴۰ سانتی‌متر', '۳٫۵۰ متر؛ سقف کاذب فضاهای تر ۴۰ سانتی‌متر', 'ارتفاع صریح دیگری در توضیحات تکمیلی ثبت می‌شود'],
    ...
    'has_boiler_room': ['بله', 'خیر'],
    'has_pool': ['بله', 'خیر'],
    'has_sauna': ['بله', 'خیر'],
    'has_jacuzzi': ['بله', 'خیر'],
    'has_fire_suppression': ['بله', 'خیر'],
    'has_mechanical_ventilation': ['بله', 'خیر'],
    ...
    'water_inlet_pressure': ['۲٫۵ bar (مبنای محافظه‌کارانه پیشنهادی)', 'کمتر از ۲ bar', 'بین ۲ تا ۳٫۵ bar', 'بیشتر از ۳٫۵ bar'],
    'water_source': ['تأیید: کنتور شهری + مخزن + بوسترپمپ', 'کنتور شهری و پمپ، بدون مخزن', 'تغذیه مستقیم آب شهری', 'مخزن و پمپ موجود با مشخصات پروژه'],
    'water_service_connection': ['پیشنهاد نزدیک ورودی اصلی', 'ضلع شمالی پروژه', 'ضلع جنوبی پروژه', 'محل ورود در پلان مشخص شده است'],
    'sanitary_outlet': ['تأیید: شبکه شهری در مرز جنوبی با تراز ±۰٫۰۰', 'اتصال به شبکه فاضلاب شهری در محل دیگر', 'چاه جذبی', 'سپتیک یا تصفیه‌خانه محلی'],
    'parking_enclosure': ['پارکینگ باز با تهویه طبیعی', 'پارکینگ نیمه‌باز', 'پارکینگ بسته/محصور', 'وضعیت مطابق ضوابط محلی تعیین شود'],
    'mechanical_shaft_route': ['پیشنهاد نزدیک هسته فضاهای تر', 'شفت کنار راه‌پله', 'شفت‌های موجود معماری استفاده شوند', 'اجازه پیشنهاد مسیر و ابعاد شفت را دارید'],
    'equipment_schedule': ['محاسبه و پیشنهاد بر اساس بار هر فضا', 'پکیج و اسپلیت مستقل برای هر واحد', 'موتورخانه مرکزی و فن‌کویل', 'تجهیزات و ظرفیت‌ها در مدارک پروژه مشخص شده‌اند'],
    'ventilation_design_basis': ['تأیید: تخلیه بالای بام/نما و هوای جبرانی از بازشوهای نما', 'تخلیه فقط به بام', 'تخلیه از نما در محل مجاز', 'مسیر و دبی در مدارک پروژه مشخص شده است'],
    'hot_water_system': ['تأیید: پکیج/منبع مرکزی و برگشت برای مسیرهای طولانی', 'پکیج مستقل بدون خط برگشت', 'منبع آب گرم مرکزی با خط برگشت', 'آبگرمکن مستقل برای هر واحد'],
    'fixture_schedule': ['تأیید پیشنهاد خودکار تجهیزات', 'تجهیزات مطابق سمبل‌های پلان معماری', 'فقط تجهیزات فضاهای تر متعارف', 'تعداد تجهیزات در جدول معماری مشخص شده است'],
    'roof_drainage_geometry': ['تأیید پیشنهاد خودکار بام', 'کف‌خواب‌ها مطابق پلان معماری', 'ناودان و رایزر آب باران در نما', 'مساحت و تعداد کف‌خواب در مدارک پروژه مشخص شده است'],
    'local_mechanical_code': ['ضابطه ویژه‌ای ابلاغ نشده است', 'مبحث ۱۴ و ۱۶ مقررات ملی ساختمان', 'ضوابط شهرداری/نظام مهندسی محل پروژه', 'الزامات خاص در مدارک پروژه درج شده است'],
    'special_loads': ['بار خاصی وجود ندارد', 'شارژر خودرو برقی', 'جکوزی/سونا یا تجهیزات تفریحی', 'پمپ یا تجهیزات مکانیکی ویژه'],
}
