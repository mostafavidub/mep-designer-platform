...
STAGES = {
    ...
    "coordinate_integrity": (74, "کنترل مقیاس یکنواخت و حفظ هندسه معماری"),
    "annotation_layout": (75, "تنظیم نوشته‌ها و رفع برخورد علائم"),
    ...
    "finalizing": (98, "ثبت نتیجه و نهایی‌سازی پروژه"),
