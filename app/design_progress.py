...
STAGES = {
    ...
    "coordination_v19": (16, "کنترل سازه و سقف کاذب و مسیرگذاری چندترازی"),
    "manufacturer_v19": (18, "کنترل مدل و محدودیت‌های تجهیزات سازنده"),
    "documentation_v19": (19, "کنترل دیتیل‌ها و تطابق پلان رایزر محاسبات و Schedule"),
    "engine_designing": (20, "طراحی نقشه‌ها و جانمایی تجهیزات با موتور v19"),
