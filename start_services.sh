#!/bin/sh
# EngiTools production release: mechanical authority pipeline v15.
set -eu
...
# CAD designer: mechanical requests use the project-driven authority pipeline;
# electrical remains on the existing preliminary rule-driven engine.
uvicorn cad_engine.main_v15:app --host 127.0.0.1 --port 8081 &
CAD_PID=$!
