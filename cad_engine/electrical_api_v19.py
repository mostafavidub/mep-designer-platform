"""Version-locked production HTTP adapter for Electrical v19."""
...
from .electrical_v1.production_v19 import design_electrical_authority_site, PIPELINE_AUTHORITY
from .electrical_v1.release_contract_v19 import release_contract_status
...
def register_electrical_v19(app):
    ...
    @app.post("/design-electrical-v19")
    def design_electrical_v19(req: DesignRequest):
        if str(req.discipline or "").lower() != "electrical":
            raise HTTPException(400, "Electrical v19 endpoint accepts electrical discipline only")
        ...
        with tempfile.TemporaryDirectory(prefix="engitools-electrical-v19-") as td:
            ...
            return {
                ...
                "engine_version": build_identity().get("commit_sha") or build_identity().get("version"),
