...
REQUIRED_CAPABILITIES = {
    **PRIOR_CAPABILITIES,
    ...
    "explicit_component_cooling_load_and_zone_diversity":"cad_engine.hvac_calculations_v19",
    "manufacturer_confirmed_idu_odu_route_validation":"cad_engine.manufacturer_selector_v19",
    "exhaust_room_coverage_flow_esp_selection":"cad_engine.hvac_calculations_v19",
    "catchment_lowpoint_drain_downpipe_rainwater_design":"cad_engine.rainwater_calculations_v19",
    "typed_level_plan_graph_derived_riser":"cad_engine.parametric_documentation_v19",
    "official_hash_only_manufacturer_database":"cad_engine.manufacturer_database_v19",
    "system_specific_manufacturer_locked_parametric_details":"cad_engine.parametric_documentation_v19",
    "manufacturer_aware_selection_calculation_book":"cad_engine.calculation_book_v19",
    "collision_priority_scale_enlargement_annotation_solver":"cad_engine.annotation_solver_v19",
    ...
    "independent_engineer_redline_feedback_loop":"cad_engine.engineering_feedback_v19",
    "quantitative_final_quality_acceptance_gate":"cad_engine.quality_acceptance_v19",
