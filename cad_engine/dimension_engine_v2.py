"""Dimension Engine v2 shadow/canonical orchestration.

V2 is shadow-first. It may compute complete intents and QA, but callers must
...
def run_dimension_engine_v2_shadow(doc,plan,architecture,pipeline,profile,board,v1_report=None,
    ...
    return {
      "version":"planha-dimension-engine-v2/1","mode":"SHADOW","profile":profile,"plan_id":plan_id,
