"""Production CAD Designer entrypoint canonical.

Electrical keeps the existing rule-driven flow.
Mechanical is routed through the authority-style engineering pipeline canonical.
"""
...
def design(req: DesignRequest):
    ...
    with tempfile.TemporaryDirectory(prefix="engitools-cad-") as td:
            ...
            if discipline=="mechanical":
                ...
                if report.get("status")!="PASS":
                    ...
                    detail={
                        ...
                        "architecture_preservation_qa_after_canonical":report.get("architecture_preservation_qa_after_canonical"),
                        ...
                        "authority_pipeline_qa":report.get("authority_pipeline_qa"),
        ...
        return {
            ...
            "build":build_identity(),
            "mode":"mechanical-authoritative" if discipline=="mechanical" else "rule-driven-preliminary",
            "preliminary":True,
