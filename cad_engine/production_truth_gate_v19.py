"""Fail-closed production truth checks for the legacy-composed v19 path.

This module does not change engineering formulas.  It turns the already-computed
legacy engineering pipeline into deterministic traceability evidence and blocks
...
def build_pipeline_traceability(pipeline: dict) -> dict:
    """Reconcile actual v13 topology -> route -> sizing into v19 identities."""
