...
def build_design_overrides(answers: dict) -> dict:
    ...
    return {
        ...
        "heating_load_kw": _answer(answers,"heating_load_kw","estimated_heating_load_kw"),
        "heating_design": {
            "supply_c": _answer(answers,"heating_supply_c"),
            "return_c": _answer(answers,"heating_return_c"),
            "indoor_c": _answer(answers,"heating_indoor_c"),
            "fluid_density_kg_m3": _answer(answers,"heating_fluid_density_kg_m3"),
            "fluid_specific_heat_j_kgk": _answer(answers,"heating_fluid_specific_heat_j_kgk"),
            "max_velocity_m_s": _answer(answers,"heating_max_velocity_m_s"),
            "max_friction_pa_m": _answer(answers,"heating_max_friction_pa_m"),
            "candidate_diameters_mm": _answer(answers,"heating_candidate_diameters_mm"),
        },
