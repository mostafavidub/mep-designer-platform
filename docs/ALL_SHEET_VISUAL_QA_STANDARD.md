...
**Status:** `LOCKED`  
**Gate revision:** `all-sheet-visual-qa/4`
...
Annotation collision measurement uses estimated painted glyph bounds rather than the unused wrapping width of an MTEXT column. Mechanical annotations emitted by the canonical composer have a minimum model-space text height of `0.08`; smaller generated text is a hard failure.
